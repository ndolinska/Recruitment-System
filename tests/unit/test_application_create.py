...
@pytest.fixture
def valid_candidate(mocker: MockFixture):
...
def test_create_application_salary_wrong(valid_offer, valid_candidate):
    valid_candidate.salary_expectations = 50000.5
...
def test_create_application_experience_too_low(valid_offer, valid_candidate):
    valid_candidate.experience = 3
...
def test_create_application_invalid_candidate(valid_offer, mocker: MockFixture):
